...
*\*Note: The script will only download the h264 compressed videos. There may be a way to get around this, but the gist of it is that non-h264 compressed videos can be the profile picture and in the HTML of another profile card. Currently, I'm not working on a fix for this edge case.*
